...
class MAPS8: UIViewController {
    ...
    override func viewDidLoad(){
        ...
        let location:CLLocationCoordinate2D = CLLocationCoordinate2DMake(37.689506, 128.753035)
        ...
        annotation.title = "Sheep Farm"
        annotation.subtitle = "Sheep Farm"
