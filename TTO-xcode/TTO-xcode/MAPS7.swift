...
class MAPS7: UIViewController {
    ...
    override func viewDidLoad(){
        ...
        let location:CLLocationCoordinate2D = CLLocationCoordinate2DMake(37.724334, 128.718918)
        ...
        annotation.title = "Sam-yang Farm"
        annotation.subtitle = "Sam-yang Farm"
