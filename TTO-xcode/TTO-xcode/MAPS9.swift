...
class MAPS9: UIViewController {
    ...
    override func viewDidLoad(){
        ...
        let location:CLLocationCoordinate2D = CLLocationCoordinate2DMake(37.731628, 128.592558)
        ...
        annotation.title = "Wol-Jeong Temple"
        annotation.subtitle = "Wol-Jeong Temple"
